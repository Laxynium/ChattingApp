...
namespace InstantMessenger.UnitTests.PermissionOverrides
{
    public class AllowPermissionForRoleTests : GroupsModuleUnitTestBase
    {
        [Fact]
        public async Task Fails_when_group_is_missing() => await Run(async sut =>
        {
            ...
            Func<Task> action = () => sut.SendAsync(new AllowPermissionForRoleCommand(@group.OwnerId, Guid.NewGuid(), @group.Channel(1).ChannelId, @group.Role(1).RoleId, "SendMessages"));
        ...
        public async Task Fails_when_member_is_missing_in_given_group() => await Run(async sut =>
        {
            ...
            Func<Task> action = () => sut.SendAsync(new AllowPermissionForRoleCommand(Guid.NewGuid(), @group.GroupId, @group.Channel(1).ChannelId, @group.Role(1).RoleId, "SendMessages"));
        ...
        public async Task Fails_when_channel_is_missing_in_given_group() => await Run(async sut =>
        {
            ...
            Func<Task> action = () => sut.SendAsync(new AllowPermissionForRoleCommand(@group.OwnerId, @group.GroupId, Guid.NewGuid(), @group.Role(1).RoleId, "SendMessages"));
        ...
        public async Task Fails_when_role_is_missing_in_given_group() => await Run(async sut =>
        {
            ...
            Func<Task> action = () => sut.SendAsync(new AllowPermissionForRoleCommand(@group.OwnerId, @group.GroupId, @group.Channel(1).ChannelId, Guid.NewGuid(), "SendMessages"));
        ...
        public async Task Fails_when_permission_is_invalid() => await Run(async sut =>
        {
            ...
            Func<Task> action = () => sut.SendAsync(new AllowPermissionForRoleCommand(@group.OwnerId, @group.GroupId, @group.Channel(1).ChannelId, @group.Role(1).RoleId, "InvalidPermission"));
        ...
        public async Task Fails_when_permission_cannot_be_overriden(string deniedPermission) => await Run(async sut =>
        {
            ...
            Func<Task> action = ()=>sut.SendAsync(new AllowPermissionForRoleCommand(@group.OwnerId, @group.GroupId, @group.Channel(1).ChannelId, @group.Role(1).RoleId, deniedPermission));
        ...
        public async Task success_when_permission_can_be_overriden(string allowedPermission) => await Run(async sut =>
        {
            ...
            await sut.SendAsync(new AllowPermissionForRoleCommand(@group.OwnerId, @group.GroupId, @group.Channel(1).ChannelId,@group.Role(1).RoleId,allowedPermission));
        ...
        public async Task Fails_when_member_has_no_valid_permission() => await Run(async sut =>
        {
            ...
            Func<Task> action = () => sut.SendAsync(new AllowPermissionForRoleCommand(@group.Member(1).UserId, @group.GroupId, @group.Channel(1).ChannelId, @group.Role(1).RoleId, "ReadMessages"));
        ...
        public async Task Success_when_member_is_owner() => await Run(async sut =>
        {
            ...
            await sut.SendAsync(new AllowPermissionForRoleCommand(@group.OwnerId, @group.GroupId, @group.Channel(1).ChannelId, @group.Role(1).RoleId, "ReadMessages"));
        ...
        public async Task Success_when_member_has_administrator_permission() => await Run(async sut =>
        {
            ...
            await sut.SendAsync(new AllowPermissionForRoleCommand(@group.Member(1).UserId, @group.GroupId, @group.Channel(1).ChannelId, @group.Role(1).RoleId, "ReadMessages"));
        ...
        public async Task Fails_when_member_with_manage_roles_permission_tries_to_override_permission_which_he_do_not_possess() => await Run(async sut =>
        {
            ...
            Func<Task> action = ()=>sut.SendAsync(new AllowPermissionForRoleCommand(@group.Member(1).UserId, @group.GroupId, @group.Channel(1).ChannelId, @group.Role(1).RoleId, "SendMessages"));
        ...
        public async Task Fails_when_member_with_manage_roles_permission_tries_to_override_manage_roles_permissions() => await Run(async sut =>
        {
            ...
            Func<Task> action = ()=>sut.SendAsync(new AllowPermissionForRoleCommand(@group.Member(1).UserId, @group.GroupId, @group.Channel(1).ChannelId, @group.Role(1).RoleId, "ManageRoles"));
        ...
        public async Task Member_without_manage_roles_permission_but_with_allow_manage_roles_override_on_role_in_given_channel_can_change_all_permissions_in_channel() => await Run(async sut =>
        {
            ...
            await sut.SendAsync(new AllowPermissionForRoleCommand(@group.Member(1).UserId, @group.GroupId, @group.Channel(1).ChannelId, @group.Role(1).RoleId, "SendMessages"));
