...
{
    public class AllowPermissionForMemberTests : GroupsModuleUnitTestBase
    {
        [Fact]
        public async Task Fails_when_group_is_missing() => await Run(async sut =>
        {
            ...
            Func<Task> action = () => sut.SendAsync(new AllowPermissionForMemberCommand(@group.OwnerId, Guid.NewGuid(), @group.Channel(1).ChannelId, @group.Member(1).UserId, "SendMessages"));
        ...
        public async Task Fails_when_member_is_missing_in_given_group() => await Run(async sut =>
        {
            ...
            Func<Task> action = () => sut.SendAsync(new AllowPermissionForMemberCommand(Guid.NewGuid(), @group.GroupId, @group.Channel(1).ChannelId, @group.Member(1).UserId, "SendMessages"));
        ...
        public async Task Fails_when_channel_is_missing_in_given_group() => await Run(async sut =>
        {
            ...
            Func<Task> action = () => sut.SendAsync(new AllowPermissionForMemberCommand(@group.OwnerId, @group.GroupId, Guid.NewGuid(), @group.Member(1).UserId, "SendMessages"));
        ...
        public async Task Fails_when_permission_is_invalid() => await Run(async sut =>
        {
            ...
            Func<Task> action = () => sut.SendAsync(new AllowPermissionForMemberCommand(@group.OwnerId, @group.GroupId, @group.Channel(1).ChannelId, @group.Member(1).UserId, "InvalidPermission"));
        ...
        public async Task Fails_when_permission_cannot_be_overriden(string deniedPermission) => await Run(async sut =>
        {
            ...
            Func<Task> action = () => sut.SendAsync(new AllowPermissionForMemberCommand(@group.OwnerId, @group.GroupId, @group.Channel(1).ChannelId, @group.Member(1).UserId, deniedPermission));
        ...
        public async Task success_when_permission_can_be_overriden(string allowedPermission) => await Run(async sut =>
        {
            ...
            await sut.SendAsync(new AllowPermissionForMemberCommand(@group.OwnerId, @group.GroupId, @group.Channel(1).ChannelId, @group.Member(1).UserId, allowedPermission));
        ...
        public async Task Success_when_member_is_owner() => await Run(async sut =>
        {
            ...
            await sut.SendAsync(new AllowPermissionForMemberCommand(@group.OwnerId, @group.GroupId, @group.Channel(1).ChannelId, @group.Member(1).UserId, "ReadMessages"));
        ...
        public async Task Fails_when_member_with_manage_roles_permission_tries_to_override_permission_which_he_do_not_possess() => await Run(async sut =>
        {
            ...
            Func<Task> action = () => sut.SendAsync(new AllowPermissionForMemberCommand(@group.Member(1).UserId, @group.GroupId, @group.Channel(1).ChannelId, @group.Member(2).UserId, "SendMessages"));
        ...
        public async Task Fails_when_member_with_manage_roles_permission_tries_to_override_manage_roles_permissions() => await Run(async sut =>
        {
            ...
            Func<Task> action = () => sut.SendAsync(new AllowPermissionForMemberCommand(@group.Member(1).UserId, @group.GroupId, @group.Channel(1).ChannelId, @group.Member(2).UserId, "ManageRoles"));
