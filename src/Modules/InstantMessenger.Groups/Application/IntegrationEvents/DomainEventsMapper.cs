    ...
    public class DomainEventsMapper : IDomainEventMapper
    {
        public Maybe<IIntegrationEvent> Map(IDomainEvent @event)
        {
            return @event switch
            {
                ...
                Domain.Events.RoleAddedToMemberEvent e =>new RoleAddedToMemberEvent(e.GroupId, e.UserId, e.MemberId,e.RoleId,e.RoleName, e.RolePriority),
                Domain.Events.RoleRemovedFromMemberEvent e => new RoleRemovedFromMemberEvent(e.GroupId, e.UserId, e.MemberId, e.RoleId, e.RoleName, e.RolePriority),
