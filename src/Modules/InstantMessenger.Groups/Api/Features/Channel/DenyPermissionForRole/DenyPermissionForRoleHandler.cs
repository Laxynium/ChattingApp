...
namespace InstantMessenger.Groups.Api.Features.Channel.DenyPermissionForRole
{
    internal sealed class DenyPermissionForRoleHandler : ICommandHandler<DenyPermissionForRoleCommand>
    {
        ...
        public DenyPermissionForRoleHandler(IGroupRepository groupRepository, IChannelRepository channelRepository, IUnitOfWork unitOfWork)
        {
